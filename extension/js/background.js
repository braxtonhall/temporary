...
var get = function (url) { return fetch(url).then(function (res) { return res.text(); }); };
exports.get = get;
var get$ = function (url) { return get(url).then(function (text) { return cheerio.load(text); }); };
exports.get$ = get$;


/***/ }),

/***/ "./ts/workers/finder/finder.ts":
/*!*************************************!*\
  !*** ./ts/workers/finder/finder.ts ***!
  \*************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.find = void 0;
var bOK_1 = __webpack_require__(/*! ./impl/bOK */ "./ts/workers/finder/impl/bOK.ts");
var LibGen_1 = __webpack_require__(/*! ./impl/LibGen */ "./ts/workers/finder/impl/LibGen.ts");
var InternetArchive_1 = __webpack_require__(/*! ./impl/InternetArchive */ "./ts/workers/finder/impl/InternetArchive.ts");
var finders = [
    bOK_1.bOK,
    LibGen_1.LibGen,
    InternetArchive_1.InternetArchive,
];
var find = function (parameters) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, Promise.all(finders.map(function (finder) { return finder(parameters); }))
                .then(function (result) { return result.flat(); })];
    });
}); };
exports.find = find;
...
/***/ "./ts/workers/finder/impl/InternetArchive.ts":
/*!***************************************************!*\
  !*** ./ts/workers/finder/impl/InternetArchive.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
exports.__esModule = true;
exports.InternetArchive = void 0;
var InternetArchive = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, []];
    });
}); };
...
/***/ "./ts/workers/finder/impl/LibGen.ts":
/*!******************************************!*\
  !*** ./ts/workers/finder/impl/LibGen.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.LibGen = void 0;
var getLinks_1 = __webpack_require__(/*! ./util/getLinks */ "./ts/workers/finder/impl/util/getLinks.ts");
var MAX = 3;
var BASE_URL = "https://libgen.is";
var getUrl = function (base, queryKey, maxLenQuery, parameters) {
    var _a;
    return "".concat(base).concat(new URLSearchParams((_a = {}, _a[queryKey] = shorten(maxLenQuery, parameters), _a)));
};
...
var shorten = function (maxLenQuery, _a) {
    var author = _a.author, title = _a.title;
    var shorterAuthor = simplify(author);
    var shorterTitle = simplify(title);
    var combined = "".concat(shorterAuthor, " ").concat(shorterTitle);
    if (combined.length > maxLenQuery) {
        var maxLengthText = combined.slice(0, maxLenQuery).trim();
...
var findFiction = function (parameters) { return __awaiter(void 0, void 0, void 0, function () {
    var searchUrl;
    return __generator(this, function (_a) {
        searchUrl = getUrl("https://libgen.is/fiction/?", "q", Infinity, parameters);
        return [2 /*return*/, (0, getLinks_1.getLinks)({
                searchUrl: searchUrl,
                baseUrl: BASE_URL,
                maxResults: MAX,
...
var findNonFiction = function (parameters) { return __awaiter(void 0, void 0, void 0, function () {
    var searchUrl;
    return __generator(this, function (_a) {
        searchUrl = getUrl("https://libgen.is/search.php?", "req", 80, parameters);
        return [2 /*return*/, (0, getLinks_1.getLinks)({
                searchUrl: searchUrl,
                baseUrl: BASE_URL + "/",
                maxResults: MAX,
...
var LibGen = function (parameters) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, Promise.all([findFiction, findNonFiction].map(function (finder) { return finder(parameters); }))
...
var bOK = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            searchUrl = "".concat(BASE_URL).concat(SEARCH_PATH, "/").concat(encodeURI("".concat(title, " ").concat(author)));
...
/***/ "./ts/workers/finder/impl/util/getLinks.ts":
/*!*************************************************!*\
  !*** ./ts/workers/finder/impl/util/getLinks.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var request_1 = __webpack_require__(/*! ../../../../services/request */ "./ts/services/request.ts");
var getLinks = function (_a) {
    var searchUrl = _a.searchUrl, aSelector = _a.aSelector, baseUrl = _a.baseUrl, maxResults = _a.maxResults;
    return __awaiter(void 0, void 0, void 0, function () {
        var $, paths;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, request_1.get$)(searchUrl)];
                case 1:
                    $ = _b.sent();
                    paths = [];
                    $(aSelector).each(function (_, element) {
                        paths.push($(element).attr("href"));
                    });
                    return [2 /*return*/, paths.slice(0, maxResults).map(function (path) { return "".concat(baseUrl).concat(path); })];
            }
        });
    });
};
...
/*!*********************************!*\
  !*** ./ts/workers/delegator.ts ***!
  \*********************************/

var _a;
exports.__esModule = true;
var types_1 = __webpack_require__(/*! ./types */ "./ts/workers/types.ts");
var finder_1 = __webpack_require__(/*! ./finder/finder */ "./ts/workers/finder/finder.ts");
var workers = (_a = {},
    _a[types_1.WorkerKind.Finder] = finder_1.find,
    _a);
